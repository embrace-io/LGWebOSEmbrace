export declare const EMB_WEB_VITALS_PREFIX = "emb-web-vitals";
export declare const CORE_WEB_VITALS: readonly ["CLS", "INP", "LCP"];
export declare const ALL_WEB_VITALS: readonly ["CLS", "INP", "LCP", "FCP", "TTFB"];
export declare const WEB_VITALS_ID_TO_LISTENER: {
    /**
     ...
     */
    readonly CLS: (onReport: (metric: import("web-vitals/attribution").CLSMetricWithAttribution) => void, opts?: import("web-vitals/attribution").AttributionReportOpts) => void;
    /**
     ...
     */
    readonly FCP: (onReport: (metric: import("web-vitals/attribution").FCPMetricWithAttribution) => void, opts?: import("web-vitals/attribution").AttributionReportOpts) => void;
    /**
     ...
     * Only measured once per page load
     */
    readonly LCP: (onReport: (metric: import("web-vitals/attribution").LCPMetricWithAttribution) => void, opts?: import("web-vitals/attribution").AttributionReportOpts) => void;
    /**
     ...
     * increase to INP.
     */
    readonly INP: (onReport: (metric: import("web-vitals/attribution").INPMetricWithAttribution) => void, opts?: import("web-vitals/attribution").INPAttributionReportOpts) => void;
    /**
     ...
     */
    readonly TTFB: (onReport: (metric: import("web-vitals/attribution").TTFBMetricWithAttribution) => void, opts?: import("web-vitals/attribution").AttributionReportOpts) => void;
