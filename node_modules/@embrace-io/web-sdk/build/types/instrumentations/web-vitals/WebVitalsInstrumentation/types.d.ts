import type { Metric, MetricWithAttribution, ReportOpts } from 'web-vitals/attribution';
...
export type WebVitalListeners = Record<Metric['name'], ((onReport: WebVitalOnReport, opts?: ReportOpts) => void) | undefined>;
