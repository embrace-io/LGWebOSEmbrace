...
class EmbraceSpanStorage {
    constructor({ storage = window.localStorage, diag: diagParam = api.diag.createComponentLogger({
...
exports.EmbraceSpanStorage = EmbraceSpanStorage;
//# sourceMappingURL=EmbraceSpanStorage.cjs.map
